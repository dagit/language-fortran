...
A future solution might provide information so that the original 'continue' can be reflected in the AST generated by 
language-fortran. But this has not been done yet. 15/08/2014- Dominic Orchard
